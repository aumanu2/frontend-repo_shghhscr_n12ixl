    ...
    <section id="about" className="relative mx-auto max-w-6xl px-6 py-20">
      <div className="grid gap-10 md:grid-cols-2 md:items-center">
        ...
        <div className="relative">
          <div className="absolute -inset-2 rounded-xl bg-gradient-to-r from-indigo-200 to-cyan-200 blur-2xl opacity-60" />
          <div className="relative rounded-xl border border-slate-200 bg-white p-6 shadow-lg">
            <dl className="grid grid-cols-2 gap-6 text-center">
              <div>
                ...
                <dd className="mt-1 text-xl font-semibold text-slate-900">Web + 3D</dd>
              </div>
              <div>
                <dt className="text-sm text-slate-500">Learning</dt>
                <dd className="mt-1 text-xl font-semibold text-slate-900">DSA, React</dd>
              </div>
              <div>
                <dt className="text-sm text-slate-500">Location</dt>
                <dd className="mt-1 text-xl font-semibold text-slate-900">India</dd>
              </div>
              <div>
                <dt className="text-sm text-slate-500">Status</dt>
                <dd className="mt-1 text-xl font-semibold text-slate-900">Open to work</dd>
              </div>
            </dl>
          </div>
        </div>
